...
import (
	...
	"github.com/arnarg/mads/pkg/mads"
...
func run(cCtx *cli.Context) error {
	...
	// Create a mads client
	client := mads.NewClient(&mads.Config{
		SocketPath: socket,
	})
	...
	for _, fpath := range paths {
		mod, err := mads.LoadModule(fpath)
		if err != nil {
			return err
		}

		if err := client.ApplyModule(context.Background(), mod); err != nil {
			return err
		}
	}
